...
Orca-hand bounce task environment.
"""
...
@configclass
class BounceCfg(OrcaEnvCfg):
    """Configuration parameters for the Orca bounce task."""

    fall_height = 0.3
    reset_position_noise = 0.01
    object_y_pos = 0.1
    object_z_pos = 0.6
    default_object_pos = (0.23, object_y_pos, object_z_pos)
    out_of_bounds = 0.2
