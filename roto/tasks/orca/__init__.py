...
from . import agents, orca_baoding, orca_bounce
...
def _variant_paths(task_name: str) -> dict[str, str]:
    # Strip the "orca" prefix so "orcabounce" → "bounce" matches the directory name
    short_name = task_name.removeprefix("orca")
...
_register_task("OrcaBounce", orca_bounce.BounceEnv, orca_bounce.BounceCfg)
_register_task("OrcaBaoding", orca_baoding.BaodingEnv, orca_baoding.BaodingCfg)
