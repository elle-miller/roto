...
# suprim
log_dir = "/home/emil/code/external/roto/results"
output_dir = "/home/emil/code/external/roto/results/plots"
    ...
    for i, experiment_name in enumerate(experiment_names):
        ...
        for reader in readers:
            ...
            for j, tag in enumerate(tags):
                ...
                step = metric["step"].to_numpy() / step_divisor
...
def get_metrics(exp_dict):
    ...
    for i, experiment_name in enumerate(experiment_names):
        ...
        for reader in readers:
            ...
            tags = exp_dict["tags"] if "tags" in exp_dict else [exp_dict["tag"]]
            for tag in tags:
