...
icra_workshop_shadow_bounce = {
    "title": "Shadow Bounce",
    "log_dir": "icra",
    "experiment_name": "shadow_bounce",
    "legend_names": ["PPO(vision)","PPO(blind)"], # "PPO(blind)+dynamics"],
    "run_names": ["rl_only_ptg", "rl_only_pt"], # "forward_dynamics"],
    "tag": "mean_eval_return",
    "color": [vision_colour, ppo_colour, dynamics_colour],
    "linestyle": ['-', '-', '-', '--', "-", "--", '-', '--', '-', '--', "-", "--", '--'],
    "max_reward": 0,
    "x_max": 199,
    "x_min": 0,
    ...
    "x_label": "Timesteps",
    "y_label": "Mean evaluation return",
    "output_file": "icra_workshop_shadow_bounce.pdf",
}

icra_workshop_shadow_baoding = {
    "title": "Shadow Baoding",
    "log_dir": "icra",
    "experiment_name": "shadow_baoding",
    "legend_names": ["PPO(vision)","PPO(blind)"], # "PPO(blind)+dynamics"],
    "run_names": ["rl_only_ptg", "rl_only_pt"], # "forward_dynamics"],
    "tag": "mean_eval_return",
    "color": [vision_colour, ppo_colour],
    "linestyle": ['-', '-', '-', '--', "-", "--", '-', '--', '-', '--', "-", "--", '--'],
    "max_reward": 0,
    "x_max": 199,
    "x_min": 0,
    ...
    "x_label": "Timesteps",
    "y_label": "Mean evaluation return",
    "output_file": "icra_workshop_shadow_baoding.pdf",
}

icra_workshop_allegro_bounce = {
    "title": "Allegro Bounce",
    "log_dir": "icra",
    "experiment_name": "bounce",
    "legend_names": ["PPO(vision)"], # "PPO(blind)+dynamics"],
    "run_names": ["allegro_rl_only_pt"], # "forward_dynamics"],
    "tag": "mean_eval_return",
    "color": [vision_colour, ppo_colour, dynamics_colour],
    "linestyle": ['-', '-', '-', '--', "-", "--", '-', '--', '-', '--', "-", "--", '--'],
    "max_reward": 0,
    ...
    "x_label": "Timesteps",
    "y_label": "Mean evaluation return",
    "output_file": "icra_workshop_allegro_bounce.pdf",
}

icra_workshop_bounce = {
    "title": "Bounce",
    "log_dir": "icra",
    "experiment_name": "bounce",
    "legend_names": ["Shadow(states)", "ORCA(states)", "Allegro(states)", "Shadow(blind)", "ORCA(blind)", "Allegro(blind)"], 
    "run_names": ["shadow_rl_only_ptg", "orca_rl_only_ptg", "allegro_rl_only_ptg", "shadow_rl_only_pt", "orca_rl_only_pt", "allegro_rl_only_pt"], 
    "tag": "mean_eval_return",
    "color": [ppo_colour, dynamics_colour, recon_colour, ppo_colour, dynamics_colour, recon_colour],
    "linestyle": ['-', "-",'-', '--', '--', '--', ],
    "max_reward": 0,
    "x_max": 194,
    "x_min": 0,
    ...
    "x_label": "Timesteps (M)",
    "y_label": "Mean evaluation return",
    "output_file": "icra_workshop_bounce.pdf",
}

icra_workshop_baoding = {
    "title": "Baoding",
    "log_dir": "icra",
    "experiment_name": "baoding",
    "legend_names": ["Shadow(states)", "Shadow(blind)"], 
    "run_names": ["shadow_rl_only_ptg","shadow_rl_only_pt"], 
    "tag": "mean_eval_return",
    "color": [ppo_colour, ppo_colour, recon_colour, dynamics_colour],
    "linestyle": ['-', "--",'-', '--', '--', '--', ],
    "max_reward": 0,
    "x_max": 194,
    "x_min": 0,
    ...
    "x_label": "Timesteps",
    "y_label": "Mean evaluation return",
    "output_file": "icra_workshop_baoding.pdf",
}